...
class Ui_MainWindow(object):
	def setupUi(self, MainWindow):
		...
		self.angle_mean_input = QtWidgets.QPlainTextEdit(self.centralwidget)
		sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Ignored)
		sizePolicy.setHorizontalStretch(0)
		sizePolicy.setVerticalStretch(0)
		...
		self.horizontalLayout_14.addWidget(self.angle_mean_input)
		self.angle_stddev_input = QtWidgets.QPlainTextEdit(self.centralwidget)
		sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Ignored)
		sizePolicy.setHorizontalStretch(0)
		sizePolicy.setVerticalStretch(0)
		...
		self.horizontalLayout_14.addWidget(self.angle_stddev_input)
		...
		self.invalid_parameters_error.setAutoFillBackground(False)
	...
	def retranslateUi(self, MainWindow):
		...
		self.size_mean_input.setPlainText(_translate("MainWindow", "35"))
		self.size_mean_input.setPlaceholderText(_translate("MainWindow", "standard mean"))
		self.size_stddev_input.setPlainText(_translate("MainWindow", "7"))
		...
		self.angle_mean_input.setPlaceholderText(_translate("MainWindow", "standard mean"))
		self.angle_stddev_input.setPlaceholderText(_translate("MainWindow", "standard deviation"))
		...
		self.csv_path_input.setPlaceholderText(_translate("MainWindow", "Path to csv file or directory"))
	...
	def generate_preview(self):
		...
		area = reader.get_area_of_layer(self.path_to_input_image, self.layer_dropdown.currentText())
		if self.check_parameters():
			defect = ParticleDefect(srcImg=self.path_to_input_image, 
								...
								angle_mean=self.angle_mean_value, angle_stddev=self.angle_stddev_value,
								curviness=self.curviness_value, 
								blur=self.blur_value, layer=self.layer_dropdown.currentText())
			self.shown_image.setPixmap(QtGui.QPixmap(defect.get_image()))
	...
	def check_parameters(self):
		...
		try:
			...
			return False
		try:
			angle_mean_value = float(self.angle_mean_input.toPlainText())
			if 360 >= angle_mean_value >= 0: 
				self.angle_mean_value = angle_mean_value
		except Exception:
			self.invalid_parameters_error.setText("Invalid angle mean")
			return False
		try:
			angle_stddev_value = float(self.angle_stddev_input.toPlainText())
			if 360 >= angle_stddev_value > 0:
				self.angle_stddev_value = angle_stddev_value
		except Exception:
			self.invalid_parameters_error.setText("Invalid angle stddev")
			return False
		try:
